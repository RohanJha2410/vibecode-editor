...
const filteredTemplates = templates.filter((template)=>{
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto bg-black border-white/5">
        {step === "select" ? (
          <>
            <DialogHeader>
            ...
            <div className="flex flex-col gap-6 py-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                  <Search
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 outline-none border-white/5"
                    size={18}
                  />
                  <Input
                      ...
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                            ${
                                ...
                                ? "border-[#E93F3F] shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]" : "hover:border-[#E93F3F] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                            } border-white/10
                            `}
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border border-white/10">
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <Button
                className="bg-[#E93F3F] hover:bg-[#d03636] cursor-pointer"
