      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button 
            ...
            className={cn(
              "relative gap-2 h-8 px-3 text-sm font-medium transition-all duration-200 border-white/5",
              isEnabled 
        ...
        <DropdownMenuContent align="end" className="w-72 bg-black border-white/1">
