        ...
        <SidebarGroup>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="border-white/10 bg-black" align="end">
              <DropdownMenuItem onClick={handleAddRootFile} className="cursor-pointer hover:bg-zinc-900">
                <FilePlus className="h-4 w-4 mr-2" />
                New File
              </DropdownMenuItem>
              <DropdownMenuItem onClick={handleAddRootFolder} className="cursor-pointer hover:bg-zinc-900">
...
"
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-black border-white/10"align="end">
              <DropdownMenuItem onClick={handleRename} className="cursor-pointer hover:bg-zinc-900">
              ...
              <DropdownMenuItem
                ...
                className="text-destructive cursor-pointer hover:bg-zinc-900  text-red-600"
              >
    ...
    return (
     ...
     cursor-pointer">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent  className="bg-black border-white/10" align="end">
                <DropdownMenuItem onClick={handleAddFile} className="cursor-pointer hover:bg-zinc-900">
                  <FilePlus className="h-4 w-4 mr-2" />
                  New File
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleAddFolder} className="cursor-pointer hover:bg-zinc-900">
                  <FolderPlus className="h-4 w-4 mr-2" />
                  New Folder
                </DropdownMenuItem>
                <DropdownMenuSeparator />
